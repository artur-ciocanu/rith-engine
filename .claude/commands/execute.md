---
description: Execute a Rith Engine implementation plan file
argument-hint: <path-to-plan.md>
---

# Execute: Implement a Rith Engine Plan

## Objective

Read and execute every task in the plan file: **$ARGUMENTS**

Implement all tasks faithfully, following Rith Engine monorepo conventions, and report results.
...
### Rith Engine conventions to follow:

**Imports:**
```typescript
// Type-only imports
import type { IPlatformAdapter, Conversation } from '@rith/core';
// Value imports — named, not namespace
import { handleMessage, pool } from '@rith/core';
...
**Package boundaries:**
- `@rith/workflows` must NOT import from `@rith/core`
- `@rith/git` must NOT import from `@rith/core` or `@rith/workflows`
- `@rith/paths` has zero `@rith/*` dependencies

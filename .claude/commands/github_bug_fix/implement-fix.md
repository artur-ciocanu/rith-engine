...
- Maintain Rith Engine coding conventions (see CLAUDE.md)
...
**Important Rith Engine test patterns:**
...
- Follow Rith Engine coding standards exactly (CLAUDE.md + relevant .claude/rules/)

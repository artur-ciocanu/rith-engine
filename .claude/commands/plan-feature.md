---
description: Create a comprehensive implementation plan for a Rith Engine feature
argument-hint: <feature-name-or-description>
---

# Plan Feature: Comprehensive Rith Engine Implementation Planning

## Objective

Produce a detailed, actionable implementation plan for: **$ARGUMENTS**

The plan will be saved to `.claude/rith/plans/{kebab-case-name}.md` and is designed to be
...
Generate the implementation plan at `.claude/rith/plans/{kebab-case-feature-name}.md`:
...
- `import * as core from '@rith/core'` — use named imports
...
1. Save the plan file to `.claude/rith/plans/{kebab-case-name}.md`

---
description: Prime agent with Rith Engine workflow engine context
---
...
to workflows, case-insensitive matching, `rith-assist` fallback, Codex tool bypass detection.
...
!`ls .rith/workflows/ 2>/dev/null || echo "(none in repo root)"`
...
### DAG Node Types
- `command:` — named command file from `.rith/commands/`

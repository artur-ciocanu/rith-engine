...
**Next steps**:
- To write requirements: `/rith-dev prd {recommended approach}`
- To plan implementation: `/rith-dev plan {recommended approach}`
- For deeper codebase context: `/rith-dev research {specific component}`

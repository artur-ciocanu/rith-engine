...
Save to `.claude/rith/plans/{slug}.plan.md` where `{slug}` is a kebab-case feature name.
...
**File**: `.claude/rith/plans/{slug}.plan.md`
...
**Next Step**: `/rith-dev implement .claude/rith/plans/{slug}.plan.md`
```

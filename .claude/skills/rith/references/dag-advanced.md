...
The Codex CLI picks up all of these automatically because Rith Engine inherits the full process environment when spawning the CLI. No Rith Engine configuration needed — just set up the Codex CLI config once.
...
- id: github-analysis
  ...
  mcp: .rith/mcp/github.json          # Path relative to repo root

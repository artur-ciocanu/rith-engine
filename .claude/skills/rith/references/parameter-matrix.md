...
One-page lookup for Rith Engine workflow parameters: which field works on which node type, how to pick the right parameter for a given intent, and the gotchas that don't fail loudly.
...
| Give a node external tools                       | `mcp: .rith/mcp/server.json`                               |
...
See [github.com/artur-ciocanu/rith-engine/guides/authoring-workflows/#inline-sub-agents](https://github.com/artur-ciocanu/rith-engine/guides/authoring-workflows/#inline-sub-agents) for a worked end-to-end example.
...
| Repo initialization, `.rith/config.yaml` schema | `repo-init.md`                                                         |
...
| Full schema reference                            | [github.com/artur-ciocanu/rith-engine/reference/configuration/](https://github.com/artur-ciocanu/rith-engine/reference/configuration/) |
...
2. Validate before running: `rith validate workflows <name>`.

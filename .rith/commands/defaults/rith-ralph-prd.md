...
mkdir -p .rith/ralph/{feature-slug}
```

### File 1: prd.md

**Output path**: `.rith/ralph/{feature-slug}/prd.md`
...
**Output path**: `.rith/ralph/{feature-slug}/prd.json`
...
| File                                  | Purpose                                      |
| ------------------------------------- | -------------------------------------------- |
| `.rith/ralph/{feature-slug}/prd.md`   | Full context - goals, UX, technical patterns |
| `.rith/ralph/{feature-slug}/prd.json` | Story tracking - passes/fails per story      |
...
1. **Full PRD** (`.rith/ralph/{feature-slug}/prd.md`) - Goals, persona, UX, technical patterns
2. **Current Story** - From `.rith/ralph/{feature-slug}/prd.json` with acceptance criteria
3. **Previous Learnings** - From `.rith/ralph/{feature-slug}/progress.txt`
...
# Initialize progress
echo "# Ralph Progress Log\nStarted: $(date)\n---" > .rith/ralph/{feature-slug}/progress.txt

# Run Ralph - specify the feature directory
@Rith Engine run ralph .rith/ralph/{feature-slug}
```
````

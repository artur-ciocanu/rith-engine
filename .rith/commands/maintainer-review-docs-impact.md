...
The project's docs site is at `packages/docs-web/` (Starlight). User-facing docs published to github.com/artur-ciocanu/rith-engine. Repo-level docs include `CLAUDE.md`, `CONTRIBUTING.md`, and any `docs/` content.
...
- `CLAUDE.md` — only if the change affects how _agents_ working in this repo should behave.

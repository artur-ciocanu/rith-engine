---
name: rith-code-review
description: |
  Reviews PR code quality, CLAUDE.md compliance, patterns, and bugs.
  Produces structured findings with fix suggestions and codebase pattern references.
  Use when performing code review on a pull request.
metadata:
  author: rith-engine
  version: '1.0'
---

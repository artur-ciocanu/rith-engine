---
name: rith-comment-quality-review
description: |
  Reviews code comments for accuracy, completeness, and maintainability.
  Identifies comment rot, documentation gaps, and misleading comments.
  Use when reviewing comment and documentation quality in a pull request.
metadata:
  author: rith-engine
  version: '1.0'
---

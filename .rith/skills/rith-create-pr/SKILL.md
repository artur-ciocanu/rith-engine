...
name: rith-create-pr
description: |
  Creates a GitHub pull request from the current branch with implementation context.
  Use when a feature branch is ready and needs a PR created with proper description,
  template compliance, and artifact tracking.
metadata:
  author: rith-engine
  version: '1.0'
---

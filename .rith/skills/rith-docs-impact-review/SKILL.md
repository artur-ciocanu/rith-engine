---
name: rith-docs-impact-review
description: |
  Checks if PR changes require documentation updates to CLAUDE.md, docs/, agents, or README.
  Produces structured impact assessment with update suggestions.
  Use when assessing documentation impact of a pull request.
metadata:
  author: rith-engine
  version: '1.0'
---
...
ls -la .rith/commands/ 2>/dev/null || true
```
...
| .rith/commands/\*.md       | NONE/LOW/HIGH | {description or "None"} |

---
name: rith-error-handling-review
description: |
  Reviews error handling for silent failures, inadequate catch blocks, and poor fallbacks.
  Produces structured findings with fix suggestions and hidden error analysis.
  Use when reviewing error handling quality in a pull request.
metadata:
  author: rith-engine
  version: '1.0'
---

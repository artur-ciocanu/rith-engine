---
name: rith-finalize-pr
description: |
  Commits changes, creates or updates a PR with template compliance, and marks it ready for review.
  Use when a workflow implementation is complete and needs to be finalized into a PR
  with proper description, artifacts, and review-ready status.
metadata:
  author: rith-engine
  version: '1.0'
---
...
1. `rith-pr-review-scope`
2. `rith-sync-pr-with-main`
3. Review agents (parallel)
4. `rith-synthesize-review`
5. `rith-implement-review-fixes`
```

---
name: rith-implement-review-fixes
description: |
  Implements CRITICAL and HIGH fixes from review findings, adds tests, and reports results.
  Commits and pushes changes, then posts a fix report to the GitHub PR.
  Use when applying automated fixes from a consolidated review report.
metadata:
  author: rith-engine
  version: '1.0'
---
...
*Auto-fixed by Rith Engine comprehensive-pr-review workflow*

---
name: rith-investigate-issue
description: |
  Investigates a GitHub issue or problem by analyzing the codebase, creating a comprehensive
  implementation plan, and posting findings to GitHub. Use when a GitHub issue number, URL,
  or problem description needs systematic investigation and planning.
metadata:
  author: rith-engine
  version: '1.0'
---

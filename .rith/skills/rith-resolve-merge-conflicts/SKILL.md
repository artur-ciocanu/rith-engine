---
name: rith-resolve-merge-conflicts
description: |
  Analyzes and resolves merge conflicts in a GitHub PR via rebase, with auto-resolution
  for simple conflicts and guided decision-making for complex ones.
  Use when a PR has merge conflicts that need to be resolved before review or merge.
metadata:
  author: rith-engine
  version: '1.0'
---
...
---
*Resolved by Rith Engine resolve-conflicts workflow*
EOF
)"
````
...
3. Request review: `@rith review this PR`
```

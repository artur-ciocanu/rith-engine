---
name: rith-self-fix-all
description: |
  Aggressively fixes all review findings from review artifacts, leaning towards fixing
  unless clearly a new concern. Commits and pushes fixes, then posts a report to GitHub.
  Use when review artifacts exist in $ARTIFACTS_DIR/review/ and all findings need to be addressed.
metadata:
  author: rith-engine
  version: '1.0'
---
...
*Self-fix by Rith Engine · aggressive mode · fixes pushed to `{HEAD_BRANCH}`*
EOF
)"
```

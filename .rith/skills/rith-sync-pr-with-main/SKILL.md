---
name: rith-sync-pr-with-main
description: |
  Syncs a PR branch with the latest main branch via rebase, resolving conflicts if any arise.
  Use when a PR branch needs to be updated with upstream changes before review or merge.
metadata:
  author: rith-engine
  version: '1.0'
---

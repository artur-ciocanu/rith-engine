---
name: rith-synthesize-review
description: |
  Synthesizes all review agent findings into a consolidated report and posts to GitHub.
  Aggregates, deduplicates, and prioritizes findings across all review agents.
  Use when combining multiple review agent outputs into a single PR review.
metadata:
  author: rith-engine
  version: '1.0'
---
...
_Reviewed by Rith Engine comprehensive-pr-review workflow_

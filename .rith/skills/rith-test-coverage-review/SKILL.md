---
name: rith-test-coverage-review
description: |
  Reviews test coverage quality, identifies gaps, and evaluates test effectiveness.
  Produces structured findings with test suggestions and criticality scores.
  Use when reviewing test coverage in a pull request.
metadata:
  author: rith-engine
  version: '1.0'
---

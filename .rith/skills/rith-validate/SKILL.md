...
name: rith-validate
description: |
  Runs the full validation suite including type-check, lint, format, tests,
  and build, fixing any failures encountered.
  Use when an implementation is complete and needs comprehensive validation
...
Continue to `rith-finalize-pr` to update PR and mark ready for review.
```
...
Proceed to `rith-finalize-pr` to update PR and mark ready for review.
```

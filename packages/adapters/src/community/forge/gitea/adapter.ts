...
const BOT_RESPONSE_MARKER = '<!-- rith-bot-response -->';
...
export class GiteaAdapter implements IPlatformAdapter {
  ...
  constructor(
    ...
    this.botMention = botMention ?? 'Rith Engine';
   ...
   * Uses @rith/git functions for safe, testable git operations.
   *
  ...
  /**
   * Auto-detect and load commands from .rith/commands/ (or configured folder)
   */

...
describe('calculatePortOffset', () => {
  it('should calculate consistent hash-based offset for worktree paths', () => {
    const testPath = '/Users/test/.rith/worktrees/owner/repo/issue-123';
  ...
  it('should produce different offsets for different worktree paths', () => {
    const path1 = '/Users/test/.rith/worktrees/owner/repo/issue-123';
    const path2 = '/Users/test/.rith/worktrees/owner/repo/issue-456';
  ...
  it('should keep offset in 100-999 range for various paths', () => {
    const testPaths = [
      '/.rith/worktrees/repo/branch',
      '/home/user/.rith/worktrees/owner/repo/issue-1',
      '/very/long/path/to/rith/worktrees/organization/repository/feature-branch-with-long-name',

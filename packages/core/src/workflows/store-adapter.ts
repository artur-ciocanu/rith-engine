/**
 * WorkflowStore adapter — bridges @rith/core DB modules to the
 * IWorkflowStore trait defined in @rith/workflows.
 */
import type { IWorkflowStore } from '@rith/workflows/store';
import type { WorkflowConfig, WorkflowDeps } from '@rith/workflows/deps';
import type { WorkflowRunStatus } from '@rith/workflows/schemas/workflow-run';
import type { MergedConfig } from '../config/config-types';
import * as workflowDb from '../db/workflows';
import * as workflowEventDb from '../db/workflow-events';
import * as codebaseDb from '../db/codebases';
import * as envVarDb from '../db/env-vars';
import { PiProvider } from '@rith/providers';
...
export function createWorkflowDeps(): WorkflowDeps {
  return {
    ...
    getAgentProvider: () => new PiProvider(),

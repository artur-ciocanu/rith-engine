...
// Brand foundation — Rith Engine shield identity.
    ...
    <section id="logo" style={{ paddingBottom: 96 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 28 }}>
        ...
        <Tile style={{ padding: "36px 24px 24px" }}>
          ...
          <RithLockup size={28} subtitle="Console"/>
        </Tile>
        <Tile dark style={{ padding: "36px 24px 24px" }}>
          <Label>On dark</Label>
          <RithLockup size={32} color="white"/>
        </Tile>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
        ...
        <Tile style={{ aspectRatio: "1 / 1", display: "grid", placeItems: "center", background: "var(--brand-teal)" }}>
          <RithGlyph size={80} color="oklch(0.18 0.04 168)"/>
        </Tile>
      </div>
...
function VoiceSection() {
  return (
    <section id="voice" style={{ paddingBottom: 96 }}>
      <Hed
        eyebrow="06 · Voice"
        title="How Rith Engine talks"
        kicker="Direct, plain, technically honest. Rith Engine explains what it did, what it's waiting for, and what it needs from you — without flattery, exclamation points, or marketing fog."
      />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        <Tile style={{ padding: 22, borderLeft: "3px solid var(--success)" }}>
          ...
          <ul style={{ margin: 0, paddingLeft: 18, fontSize: 14, color: "var(--text)", lineHeight: 1.7 }}>
            ...
            <li>Rith Engine is asking a question.</li>
          </ul>
        </Tile>
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      <header style={{
        ...
        <RithLockup size={22} subtitle="Brand"/>
      </header>
        ...
        <main style={{ flex: 1, minWidth: 0, padding: "40px 28px 100px" }}>
          ...
          <div style={{ marginBottom: 72, position: "relative" }}>
            ...
            <h1 style={{ margin: 0, fontSize: 64, fontWeight: 600, letterSpacing: "-0.035em", lineHeight: 1.02, color: "var(--text)", maxWidth: 820 }}>
              The system behind <span className="brand-text">Rith Engine</span>.
            </h1>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 32 }}>
              ...
              <a href={window.getBuddyHref ? window.getBuddyHref("console") : "Rith Engine Console.html"} style={{
                display: "inline-flex", alignItems: "center", gap: 6,
          ...
          <footer style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <RithGlyph size={16} color="var(--text-tertiary)"/>
              <span className="mono">rith · brand v1.0</span>
            </div>

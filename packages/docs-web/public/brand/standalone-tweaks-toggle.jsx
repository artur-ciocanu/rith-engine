...
// "Rith Engine Console.html" + "Brand.html". In the bundled standalones they
// live as "Rith Engine Console — Standalone.html" + "Rith Engine Brand — Standalone.html".
...
function getBuddyHref(target /* "console" | "brand" */) {
  ...
  if (target === "console") {
    return isStandalone ? "Rith Engine Console — Standalone.html" : "Rith Engine Console.html";
  }
  return isStandalone ? "Rith Engine Brand — Standalone.html" : "Brand.html";
}

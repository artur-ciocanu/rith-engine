...
#
# Usage: irm https://github.com/artur-ciocanu/rith-engine/install.ps1 | iex
#
...
#   $env:VERSION = "v0.2.0"; irm https://github.com/artur-ciocanu/rith-engine/install.ps1 | iex
#
#   # Install to custom directory
#   $env:INSTALL_DIR = "C:\tools\rith"; irm https://github.com/artur-ciocanu/rith-engine/install.ps1 | iex

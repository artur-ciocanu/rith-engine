---
title: Discord
description: Connect Rith Engine to Discord for AI coding assistance in servers and DMs.
category: adapters
area: adapters
...
Connect Rith Engine to Discord so you can interact with your AI coding assistant from any Discord server or DM.
...
`Used disallowed intents`. Rith Engine will log

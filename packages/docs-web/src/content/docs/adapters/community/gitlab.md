---
title: GitLab
description: Connect Rith Engine to GitLab for AI coding assistance in issues and merge requests.
category: adapters
area: adapters
audience: [operator]
sidebar:
...
Connect Rith Engine to a GitLab instance (gitlab.com or self-hosted) so you can interact with your AI coding assistant from issues and merge requests.
...
**First mention** automatically clones the repository to `~/.rith/workspaces/<group>/<project>`, detects `.rith/commands/` if present, and injects full issue/MR context.

---
title: GitHub
description: Connect Rith Engine to GitHub via webhooks to interact from issues and pull requests.
category: adapters
area: adapters
...
Connect Rith Engine to GitHub so you can interact with your AI coding assistant from issues and pull requests.

...
description: Overview of all platform adapters available for connecting to Rith Engine.
category: adapters
area: adapters
...
Rith Engine supports multiple platform adapters. Each adapter connects Rith Engine to a different communication channel, letting you trigger workflows and interact with AI agents from wherever you work.
...
- **Message ingestion** -- receiving messages from the platform and forwarding them to Rith Engine's orchestrator
...
- **Conversation tracking** -- mapping platform-specific identifiers (thread IDs, chat IDs, issue numbers) to Rith Engine conversations

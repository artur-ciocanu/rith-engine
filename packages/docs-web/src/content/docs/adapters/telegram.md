---
title: Telegram
description: Connect Rith Engine to Telegram using the Bot API for mobile and desktop access.
category: adapters
area: adapters
...
Connect Rith Engine to Telegram so you can interact with your AI coding assistant from any Telegram client.

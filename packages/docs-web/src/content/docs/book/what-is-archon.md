---
title: What Is Rith Engine?
description: Rith Engine makes your AI coding assistant predictable by giving it a deterministic process to follow.
category: book
part: orientation
audience: [user]
sidebar:
...
Rith Engine makes your AI coding assistant predictable. Not by limiting it — by giving it a process to follow.
...
Rith Engine separates **what happens** from **how the AI thinks**.
...
Everything in Rith Engine builds on three ideas:
...
That's it. Everything else in Rith Engine builds on these three ideas.

---

## What Can You Do With Rith Engine?

Rith Engine ships with workflows for the most common development tasks:

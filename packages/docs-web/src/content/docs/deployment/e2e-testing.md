---
title: E2E Testing
description: Set up agent-browser for end-to-end browser testing in Rith Engine workflows.
category: deployment
area: infra
...
Rith Engine uses [agent-browser](https://github.com/vercel-labs/agent-browser) (by Vercel Labs) for end-to-end browser testing in workflows like `rith-validate-pr`. It is an **optional** external dependency — core Rith Engine functionality works without it.
...
|----------|------|---------|
| `rith-validate-pr` | Workflow | E2E testing phase of PR validation |
| `validate-ui` | Skill | Comprehensive UI testing |
| `replicate-issue` | Skill | Issue reproduction via browser |
| `rith-validate-pr-e2e-main.md` | Command | E2E tests against the main branch |
| `rith-validate-pr-e2e-feature.md` | Command | E2E tests against the feature branch |

## Platform-Specific Notes

### Docker

agent-browser is **pre-installed** in the Rith Engine Docker image. No action needed.

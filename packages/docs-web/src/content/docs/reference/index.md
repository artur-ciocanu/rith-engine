---
title: Reference
description: Technical reference for Rith Engine's architecture, CLI, commands, database, configuration, and troubleshooting.
category: reference
audience: [developer]
sidebar:
  order: 0
...
Technical reference documentation for Rith Engine internals.

## Reference Docs

- **[Architecture](/reference/architecture/)** -- System overview, interfaces, data flow, extension guides
- **[Rith Engine Directories](/reference/rith-directories/)** -- Directory structure, path resolution, configuration system

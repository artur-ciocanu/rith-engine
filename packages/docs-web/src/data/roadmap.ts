...
export const roadmapItems: RoadmapItem[] = [
  {
    ...
    bullets: [
      ...
      'Pi Coding Agent integration (supports ~20 LLM backends)',
    ],
    tags: ['core', 'cli', 'dag'],
  },
  {
    ...
    status: 'shipped',
    version: 'v0.2',
    description: 'Trigger Rith Engine workflows from any surface — Slack, Telegram, GitHub, Web UI, Discord — and deploy anywhere.',
    bullets: [
  ...
  },
  {
    ...
    status: 'shipped',
    version: 'v0.3',
    description: 'Run Rith Engine workflows with Pi — an open-source, multi-model coding agent. Breaks the Claude Code / Codex lock-in and opens Rith Engine to GPT, Gemini, Qwen, DeepSeek, and more.',
    bullets: [
      'Pi coding agent as a first-class Rith Engine provider',
  ...
  },
  {
    ...
    status: 'in-progress',
    version: 'v0.4',
    description: 'Getting started with Rith Engine should take under 5 minutes. A fully self-contained binary, one-line installers, and a first-run wizard that auto-detects your AI provider.',
    bullets: [
  ...
  },
  {
    ...
    status: 'next',
    version: 'v0.5',
    description: 'An open source registry for community-built Rith Engine workflows. Browse, install, and share workflows in one place.',
    bullets: [
      'github.com/artur-ciocanu/rith-engine/workflows — searchable, filterable directory',
      'WORKFLOW.md spec — standard format for shareable workflows',
      'One-command install: rith workflow install <slug>',
  ...
  },
  {
    ...
    bullets: [
      ...
      'rith workflow eval <name> — run evals from the CLI',
    ],
  ...
  },
  {
    ...
    status: 'planned',
    description: 'Connect Rith Engine to local inference servers and OpenAI-compatible API proxies — bring your own model.',
    bullets: [
      'OpenAI-compatible baseURL configuration',
      'Runtime workflow variables for dispatch-time model selection',
      'Bundled workflows use Pi provider with configurable model selection',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Defensive handling of provider error patterns and edge cases',
  ...
  {
    slug: 'pi-provider-enhancements',
    title: 'Pi Provider Enhancements',
    status: 'planned',
    tier: 'secondary',
    description: 'Pi provider enhancements — model selection, extension ecosystem improvements.',
    bullets: [],
    tags: ['providers'],

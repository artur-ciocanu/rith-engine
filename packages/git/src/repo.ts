 ...
 * the remote. This is safe for Rith Engine-managed clones in `~/.rith/workspaces/` but
...
export async function syncWorkspace(
  ...
  // Hard-reset local working tree to match origin — only safe for Rith Engine-managed

...
const GITHUB_API_URL = 'https://api.github.com/repos/artur-ciocanu/rith-engine/releases/latest';

function getCachePath(): string {
  return join(getRithHome(), CACHE_FILE);
}
  ...
  try {
    ...
    try {
      const res = await fetch(GITHUB_API_URL, {
        ...
        headers: { 'User-Agent': 'rith-update-check' },
      });

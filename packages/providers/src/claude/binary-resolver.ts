/**
 * Claude Code CLI resolver for compiled (bun --compile) rith binaries.
 *
...
import { BUNDLED_IS_BINARY, createLogger } from '@rith/paths';
...
const INSTALL_INSTRUCTIONS =
  ...
  'To fix, install Claude Code and point Rith Engine at it:\n\n' +
  ...
  'Persist the path in ~/.rith/config.yaml instead of the env var:\n' +
  '    assistants:\n' +
  '      claude:\n' +
  '        claudeBinaryPath: /absolute/path/to/claude\n\n' +
  'See: https://github.com/artur-ciocanu/rith-engine/docs/reference/configuration#claude';

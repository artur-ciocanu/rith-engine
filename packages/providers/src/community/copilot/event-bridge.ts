 ...
 * and Rith Engine's async-generator MessageChunk contract.
 *
...
/**
 * Coerce the SDK's `assistant.usage.data` shape into Rith Engine's TokenUsage.
...
/**
 * Translate one Copilot SDK `SessionEvent` into zero or more Rith Engine
 ...
 * Rith Engine's own idle / abort machinery gets a say. The SDK docs also note
 ...
 * background, orphaned. We therefore set a 60-minute ceiling (2× Rith Engine's

...
export interface NoopResourceLoaderOptions {
   ...
   *
   * Used by the Pi provider to thread Rith Engine's name-based `skills:` node
 ...
 * Rith Engine is the source of truth for skills, prompts, themes, and context
 ...
 * are still driven by Rith Engine's explicit `additionalSkillPaths` plumbing.
 *

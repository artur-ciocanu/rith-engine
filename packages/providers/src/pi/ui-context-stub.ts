...
export function createRithUIBridge(): RithUIBridge {
...
/**
 * Minimal ExtensionUIContext for Rith Engine's headless Pi sessions. Binding this
 ...
 */
export function createRithUIContext(bridge: RithUIBridge): ExtensionUIContext {
  ...
  return {
    ...
    setTheme(_theme: string | Theme): { success: boolean; error?: string } {
      return {
        success: false,
        error: 'Theme switching not supported in Rith Engine remote UI stub',
      };
    },

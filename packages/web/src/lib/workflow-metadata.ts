...
export function parseWorkflowDescription(description: string): ParsedDescription {
  ...
  // Fallback: "Handles:" (e.g., rith-assist)
  if (!result.whenToUse) {
  ...
  // Fallback: "Capability:" (e.g., rith-assist)
  if (!result.does) {

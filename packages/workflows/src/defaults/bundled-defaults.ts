 ...
 * `.rith/{commands,workflows}/defaults/` by `scripts/generate-bundled-defaults.ts`.
 ...
 *
 * Reads the build-time constant `BUNDLED_IS_BINARY` from `@rith/paths`.
 ...
 * without resorting to `mock.module('@rith/paths', ...)` — which is

 ...
 * .claude/skills/rith/. The bundled-skill.ts file is hand-maintained
 ...
 *
 * Exit codes:
 *   0  bundled-skill.ts covers every file under .claude/skills/rith/
...
const SKILL_ROOT = join(REPO_ROOT, '.claude', 'skills', 'rith');

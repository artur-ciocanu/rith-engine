#!/usr/bin/env bash
# scripts/install.sh
# Install Rith Engine CLI from GitHub releases
#
# Usage:
...
main() {
  echo ""
  echo "  ╔═══════════════════════════════════════╗"
  echo "  ║      Rith Engine CLI Installer             ║"
  echo "  ╚═══════════════════════════════════════╝"
  echo ""
  ...
  echo ""
  echo "Get started:"
  echo "  rith workflow list"
  echo "  rith workflow run assist \"What workflows are available?\""
  echo ""
}
